 ...
 */
export function run_thermal_simulation(fwhm, magic_area, n_matrix, layer_thickness, sink_thickness, plate_dimension, cpv_scale, n_xy_param, n_z_layer, use_circular_cpv, base_kt, base_emi, sink_kt, sink_emi, use_fins, use_reflector) {
    const ret = wasm.run_thermal_simulation(fwhm, magic_area, n_matrix, layer_thickness, sink_thickness, plate_dimension, cpv_scale, n_xy_param, n_z_layer, use_circular_cpv, base_kt, base_emi, sink_kt, sink_emi, use_fins, use_reflector);
