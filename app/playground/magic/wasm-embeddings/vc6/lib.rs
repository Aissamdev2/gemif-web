...
pub fn run_thermal_simulation(
    ...
    magic_area: f64,
    n_matrix: usize,
    layer_thickness: f64,   // Base plate thickness
    sink_thickness: f64,    // NEW: Heat sink thickness
    plate_dimension: f64,   
    cpv_scale: f64,         
    n_xy_param: usize,      
    n_z_layer: usize,       
    use_circular_cpv: bool, 
    // NEW: Base Material Properties
    base_kt: f64,
    base_emi: f64,
    // NEW: Sink Material Properties
    sink_kt: f64,
    sink_emi: f64,
    // NEW: Logic Toggles
    use_fins: bool,
