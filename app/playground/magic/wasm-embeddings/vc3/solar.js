 ...
 */
export function run_thermal_simulation(fwhm, magic_area, n_matrix, layer_thickness, plate_dimension, cpv_scale, n_xy_param, n_z_layer, use_circular_cpv) {
    const ret = wasm.run_thermal_simulation(fwhm, magic_area, n_matrix, layer_thickness, plate_dimension, cpv_scale, n_xy_param, n_z_layer, use_circular_cpv);
