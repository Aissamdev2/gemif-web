...
export function run_thermal_simulation(fwhm: number, magic_area: number, n_matrix: number, layer_thickness: number, plate_dimension: number, cpv_scale: number, n_xy_param: number, n_z_layer: number, use_circular_cpv: boolean): SimulationResult;
...
export interface InitOutput {
  ...
  readonly run_thermal_simulation: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => number;
