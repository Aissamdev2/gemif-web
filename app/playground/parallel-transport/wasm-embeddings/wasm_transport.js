 ...
 */
export function parallel_transport_latitude(phi, steps) {
    const ret = wasm.parallel_transport_latitude(phi, steps);
    return TransportResult.__wrap(ret);
}
...
export class TransportResult {
     ...
     */
    get points() {
        const ret = wasm.transportresult_points(this.__wbg_ptr);
     ...
     */
    get vectors() {
        const ret = wasm.transportresult_vectors(this.__wbg_ptr);
        var v1 = getArrayF64FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 8, 8);
        return v1;
    }
     ...
     */
    get return_delta() {
        const ret = wasm.transportresult_return_delta(this.__wbg_ptr);
        return ret;
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('wasm_transport_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
