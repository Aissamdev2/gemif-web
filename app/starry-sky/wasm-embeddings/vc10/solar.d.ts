...
export function run_thermal_simulation(fwhm: number, magic_area: number, n_matrix: number, layer_thickness: number, sink_thickness: number, pv_thickness: number, plate_dimension: number, cpv_scale: number, n_xy_param: number, n_z_layer: number, n_z_sink: number, use_circular_cpv: boolean, use_standard_pv: boolean, base_kt: number, base_emi: number, sink_kt: number, sink_emi: number, use_fins: boolean, use_reflector: boolean, wind_speed: number, ambient_temp_c: number, q_solar: number): SimulationResult;
...
export interface InitOutput {
  ...
  readonly run_thermal_simulation: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number, q: number, r: number, s: number, t: number, u: number, v: number) => number;
