...
export function run_thermal_simulation(fwhm: number, magic_area: number, n_matrix: number, layer_thickness: number, sink_thickness: number, pv_thickness: number, plate_dimension: number, cpv_scale: number, n_xy_param: number, n_z_layer: number, n_z_sink: number, use_circular_cpv: boolean, use_standard_pv: boolean, use_solar_cell: boolean, base_kt: number, base_emi: number, sink_kt: number, sink_emi: number, use_fins: boolean, use_reflector: boolean, wind_speed: number, ambient_temp_c: number, q_solar: number, fin_height: number, fin_spacing: number, fin_thickness: number, fin_efficiency_param: number, optical_efficiency: number, pv_efficiency_param: number): SimulationResult;
