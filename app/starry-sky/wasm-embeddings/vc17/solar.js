 ...
 * @param {number} ambient_temp_c
 * @param {number} q_solar
 * @param {number} fin_height
 * @param {number} fin_spacing
 * @param {number} fin_thickness
 * @param {number} fin_efficiency_param
 * @param {number} optical_efficiency
 * @param {number} pv_efficiency_param
 * @returns {SimulationResult}
 */
export function run_thermal_simulation(fwhm, magic_area, n_matrix, layer_thickness, sink_thickness, pv_thickness, plate_dimension, cpv_scale, n_xy_param, n_z_layer, n_z_sink, use_circular_cpv, use_standard_pv, use_solar_cell, base_kt, base_emi, sink_kt, sink_emi, use_fins, use_reflector, wind_speed, ambient_temp_c, q_solar, fin_height, fin_spacing, fin_thickness, fin_efficiency_param, optical_efficiency, pv_efficiency_param) {
    const ret = wasm.run_thermal_simulation(fwhm, magic_area, n_matrix, layer_thickness, sink_thickness, pv_thickness, plate_dimension, cpv_scale, n_xy_param, n_z_layer, n_z_sink, use_circular_cpv, use_standard_pv, use_solar_cell, base_kt, base_emi, sink_kt, sink_emi, use_fins, use_reflector, wind_speed, ambient_temp_c, q_solar, fin_height, fin_spacing, fin_thickness, fin_efficiency_param, optical_efficiency, pv_efficiency_param);
