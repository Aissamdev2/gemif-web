 ...
 */
export function run_thermal_simulation(fwhm, magic_area, n_matrix, layer_thickness, sink_thickness, pv_thickness, plate_dimension, cpv_scale, n_xy_param, n_z_layer, use_circular_cpv, use_standard_pv, base_kt, base_emi, sink_kt, sink_emi, use_fins, use_reflector, wind_speed, ambient_temp_c, q_solar) {
    const ret = wasm.run_thermal_simulation(fwhm, magic_area, n_matrix, layer_thickness, sink_thickness, pv_thickness, plate_dimension, cpv_scale, n_xy_param, n_z_layer, use_circular_cpv, use_standard_pv, base_kt, base_emi, sink_kt, sink_emi, use_fins, use_reflector, wind_speed, ambient_temp_c, q_solar);
