...
export default function Home() {
  return (
    <main className=" bg-fullscreen relative flex justify-start px-14 gap-20 md:gap-32 h-screen w-screen overflow-hidden" >
      ...
      <div className="flex flex-col justify-center gap-10">
        <div className="flex flex-col justify-center items-start gap-4 z-10">
          <h1 className="text-8xl md:text-6xl font-bold text-[#275077] ">Grado en Ingeniería</h1>
          <h1 className="text-8xl md:text-6xl font-bold text-[#275077] ">Matemática</h1>
          <h1 className="text-8xl md:text-6xl font-bold text-[#275077] ">y Física</h1>
          <div className="flex flex-col md:flex-row gap-1 mt-4 justify-center items-center">
            <h2 className="text-xl text-[#507798] font-semibold">Recursos para estudiantes</h2>
          </div>
        </div>
        <div className="flex justify-center items-center w-[60%]">
          <Link href="/login" className="z-10 py-2 px-5 md:py-4 md:px-8 text-xl bg-[#4A90E2] text-white rounded-md cursor-pointer font-semibold text-center shadow-xs transition-all duration-500 hover:bg-[#3A7BC4]">
            Acceder
          </Link>
        </div>
